...
// Login — AnuncIA (v2.0 · marca oficial "vidro gelo")
// ------------------------------------------------------------------
// VITRINE minimalista, estilo Vercel/Linear: só a marca oficial (logo
// vidro gelo, arquivo em public/logo-anuncia.png) + o cartão de vidro.
// Zero texto de apoio — o produto fala.
...
// Notas de marca: a imagem já traz o PRÓPRIO quadrado de vidro —
// por isso NADA de caixa/anel ao redor (só uma sombra de profundidade).
// Tamanho da marca aqui: 78px (56px + 40% · pedido do dono).
// A mesma logo vive na barra lateral (47px) e na aba do navegador
// (src/app/icon.png).
//
    ...
    <div className="fixed inset-0 z-[100] overflow-y-auto bg-background bg-grid">
      ...
      <div className="relative flex min-h-full items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          {/* Marca — só símbolo e nome. Nada mais. A imagem já traz o
              próprio vidro: sem caixa e sem anel ao redor. */}
          <div className="mb-8 flex flex-col items-center text-center">
            <Image
              ...
              height={78}
              priority
              className="mb-4 h-[78px] w-[78px] rounded-2xl shadow-lg"
            />
