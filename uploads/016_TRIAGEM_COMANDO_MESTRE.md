# 016 — TRIAGEM SOBERANA — "COMANDO MESTRE" (prompt vindo de engenharia externa)
...
Estes blocos do comando = são a definição técnica do que já chamamos
de "Cérebro vivo Diretor de Tráfego". Ficam **travados pra v3.0**, mas agora com
vocabulário rico:
